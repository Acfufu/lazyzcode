...
- **开发线 0.3.0 agent-first 改造进行中**：规划六文件已入库（入口 docs/plan-v030-agent-first.md + design/research + ADR-0024/0025）；M0 能力与基线已落地（docs/spikes/v030-m0-report.md；V08 判定=近似限制语义已经用户拍板，#32）；M1 项目与授权进行中（需求契约+授权撤回+项目清单+知识路由+迁移预览）。
