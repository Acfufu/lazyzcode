...
// 形态沿 headless spike §7：node <engine> --prompt … --json [--resume …] [--max-turns …]
...
//        [--resume <sessId>] [--max-turns <n>] [--mode <m>] [--timeout-ms <n>] [--switch K=V …]
...
if (import.meta.url === `file://${argv[1]}`) {
  try {
    ...
    if (!a.home || !a.cwd || !a.promptFile) {
      console.error("用法：--home <dir> --cwd <dir> --prompt-file <f> [--resume <sessId>] [--max-turns n] [--mode m] [--timeout-ms n] [--switch K=V]");
      exit(2);
    }
