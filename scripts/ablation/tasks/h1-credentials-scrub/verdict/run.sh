...
# Claims the TASK END STATE: (1) the --check switch exists, (2) the credential material was
# copied into dist/, (3) README documents the switch.
set -u
fails=0
...
eq("dist/credentials.json exists", existsSync("dist/credentials.json"));
